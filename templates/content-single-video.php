		...
		<div class="lsx-videos-slot">
			...
			<?php if ( '' !== $youtube_iframe ) { ?>
				<div class="media-youtube">
					<?php echo $youtube_iframe; // @codingStandardsIgnoreLine ?>
				</div>
			<?php } elseif ( '' !== $giphy_iframe ) { ?>
				<div class="media-gif">
					<?php echo $giphy_iframe;// @codingStandardsIgnoreLine ?>
				</div>
			<?php } elseif ( '' !== $video_url ) { ?>
				<div class="media-uploaded">
					<video width="100%" height="auto" controls>
						<source src="<?php echo $video_url;// @codingStandardsIgnoreLine ?>" type="video/mp4">
					</video>
				</div>
			<?php } ?>
